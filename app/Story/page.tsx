          ...
          <section className="bg-[hsl(var(--card))] p-4 sm:p-6 rounded-2xl shadow-xl transform transition-all hover:shadow-2xl duration-300 border border-[hsl(var(--border))]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[ 
                  ...
                  { name: "SALMA MOHAMED (Finance Officer)", image: "salmamohamed.jpeg" },
                  { name: "MAUREEN BUYA (Project Manager)", image: "maureenbuya.jpeg" },
                  { name: "BOB WANDATI (Hub Manager)", image: "bob.jpg" },
                  { name: "HAWO FARAH (Communication)", image: "hawo.jpeg" },
                  { name: "MATI KODE (ICT Trainer)", image: "mati.jpg" },
                ].map((member, index) => (
