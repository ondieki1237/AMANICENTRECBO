    ...
    <div className="flex justify-start">
      <div className="text-left max-w-lg space-y-8">
        ...
        <p className="text-base sm:text-lg text-gray-800 bg-white p-6 rounded-xl shadow-md border border-gray-100">
          <span className="font-bold">"80% of the population in Tana River County consume news primarily through radio."</span>
          <br />
          <span className="text-sm text-gray-600">Status of the Media Report 2020, Media Council of Kenya</span>
        </p>
      </div>
    </div>
  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div className="bg-gray-50 p-6 sm:p-8 rounded-2xl shadow-lg border border-gray-100">
              <h3 className="font-display text-xl sm:text-2xl text-gray-900 mb-4">Areas of Focus</h3>
              <ul className="space-y-3">
                {['Climate education', 'Civic engagement', 'Arts and Culture', 'Youth and Women Empowerment', 'Peacebuilding', 'Economic empowerment'].map((item, index) => (
            ...
            {[
              {
                ...
                description: "For 8 years now, we continue to transform lives through educative radio programs and community listening meetings."
              },
              {
                title: "Regional Coverage",
                description: "Our coverage of local stories and issues extends across Kenya's north east coastal region."
              },
              {
                title: "Inclusive Voice",
                description: "We amplify the voices of specific community members (e.g. women, children, disabled, minority languages)."
              },
              {
                title: "Trusted Voice",
                description: "Our coverage and content is unbiased and does not favour any individual or group."
              }
            ].map((item, index) => (
              <div key={index} className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100">
                <h3 className="font-display text-xl sm:text-2xl text-gray-900 mb-3">{item.title}</h3>
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="grid md:grid-cols-2 gap-10 items-center">
      ...
      <div>
        ...
        <div className="mt-10">
          <h3 className="font-display text-xl sm:text-2xl text-gray-900 mb-6">Opportunity Areas</h3>
          <div className="grid sm:grid-cols-2 gap-6">
            {[
              ...
              <div key={index} className="bg-gray-50 p-5 rounded-xl border border-gray-200 flex items-center">
                <span className="bg-red-600 text-white rounded-full w-8 h-8 flex items-center justify-center mr-4 flex-shrink-0">{index + 1}</span>
